...
import { RadarChart, Radar, PolarGrid, PolarAngleAxis, PolarRadiusAxis, Tooltip, ResponsiveContainer, PieChart, Pie, Cell } from "recharts";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
        ...
        <div className="bg-white/[0.04] border border-white/[0.07] rounded-xl p-5">
          ...
          <ResponsiveContainer width="100%" height={280}>
            <RadarChart data={catAvgs} margin={{ top: 20, right: 30, bottom: 20, left: 30 }}>
